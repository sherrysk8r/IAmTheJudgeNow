...
struct SwiftChartDefaults {
    ...
    static var labelSettings: ChartLabelSettings {
        return ChartLabelSettings(font: SwiftChartDefaults.labelFont)
    }
    
    static var labelFont: UIFont {
        return SwiftChartDefaults.fontWithSize(Env.iPad ? 14 : 11)
    }
    
    static var labelFontSmall: UIFont {
        return SwiftChartDefaults.fontWithSize(Env.iPad ? 12 : 10)
    }
